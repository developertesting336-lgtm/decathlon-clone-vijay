...
const PAGE_SLUG = "workout-essentials";
...
const WorkoutEssentials = () => {
  ...
  if (loading) {
    return (
      <div className="dynamic-page dynamic-page-workout-essentials workout-essentials-page">
        <Navbar />
        <CategoryNav />
    ...
    return (
      <div className="dynamic-page dynamic-page-workout-essentials workout-essentials-page">
        ...
        <div className="dynamic-page-not-found">
          <h1>Workout Essentials Page Not Found</h1>
  ...
  return (
    <div className="dynamic-page dynamic-page-workout-essentials workout-essentials-page">
      ...
      <main className="dynamic-page-container dynamic-page-container-workout-essentials workout-essentials-container">
