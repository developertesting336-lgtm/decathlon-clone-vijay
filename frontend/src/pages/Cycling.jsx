...
const Cycling = () => {
  ...
  if (loading) {
    return (
      <div className="dynamic-page dynamic-page-cycling cycling-page">
        <Navbar />
        <CategoryNav />
  ...
  return (
    <div className="dynamic-page dynamic-page-cycling cycling-page">
      ...
      <main className="dynamic-page-container dynamic-page-container-cycling cycling-container">
