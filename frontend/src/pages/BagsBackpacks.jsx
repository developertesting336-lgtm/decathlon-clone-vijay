...
const PAGE_SLUG = "bags-backpacks";
...
const BagsBackpacks = () => {
  ...
  if (loading) {
    return (
      <div className="dynamic-page dynamic-page-bags-backpacks bags-backpacks-page">
        <Navbar />
        <CategoryNav />
    ...
    return (
      <div className="dynamic-page dynamic-page-bags-backpacks bags-backpacks-page">
        ...
        <div className="dynamic-page-not-found">
          <h1>Bags & Backpacks Page Not Found</h1>
  ...
  return (
    <div className="dynamic-page dynamic-page-bags-backpacks bags-backpacks-page">
      ...
      <main className="dynamic-page-container dynamic-page-container-bags-backpacks bags-backpacks-container">
