...
const Activewear = () => {
  ...
  if (loading) {
    return (
      <div className="dynamic-page dynamic-page-activewear activewear-page">
        <Navbar />
        <CategoryNav />
    ...
    return (
      <div className="dynamic-page dynamic-page-activewear activewear-page">
        ...
        <div className="dynamic-page-not-found">
          <h1>Activewear Page Not Found</h1>
  ...
  return (
    <div className="dynamic-page dynamic-page-activewear activewear-page">
      ...
      <main className="dynamic-page-container dynamic-page-container-activewear activewear-container">
