...
const PAGE_SLUG = "hiking-trekking";
...
const HikingTrekking = () => {
  ...
  if (loading) {
    return (
      <div className="dynamic-page dynamic-page-hiking-trekking hiking-trekking-page">
        <Navbar />
        <CategoryNav />
    ...
    return (
      <div className="dynamic-page dynamic-page-hiking-trekking hiking-trekking-page">
        ...
        <div className="dynamic-page-not-found">
          <h1>Hiking & Trekking Page Not Found</h1>
  ...
  return (
    <div className="dynamic-page dynamic-page-hiking-trekking hiking-trekking-page">
      ...
      <main className="dynamic-page-container dynamic-page-container-hiking-trekking hiking-trekking-container">
