...
const PAGE_SLUG = "monsoon-essentials";
...
const MonsoonEssentials = () => {
  ...
  if (loading) {
    return (
      <div className="dynamic-page dynamic-page-monsoon-essentials monsoon-essentials-page">
        <Navbar />
        <CategoryNav />
    ...
    return (
      <div className="dynamic-page dynamic-page-monsoon-essentials monsoon-essentials-page">
        ...
        <div className="dynamic-page-not-found">
          <h1>Monsoon Essentials Page Not Found</h1>
  ...
  return (
    <div className="dynamic-page dynamic-page-monsoon-essentials monsoon-essentials-page">
      ...
      <main className="dynamic-page-container dynamic-page-container-monsoon-essentials monsoon-essentials-container">
