...
const CategoryNav = ({ section, data }) => {
  const [activeCategory, setActiveCategory] = useState(null);
  const navRef = useRef(null);

  const megaMenuData = data?.megaMenu || section?.data?.megaMenu || defaultMegaMenuData;
        ...
        <div className="megamenu-overlay">
          <div className="megamenu-content">
            ...
            <div className="megamenu-grid">
              {megaMenuData[activeCategory].sections.map((sec, idx) => (
                <div className="megamenu-section" key={idx}>
                  <h3 className="megamenu-section-title">{sec.title}</h3>
