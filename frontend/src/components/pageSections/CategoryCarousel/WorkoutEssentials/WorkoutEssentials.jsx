...
const WorkoutEssentials = ({
  ...
  const fetchSectionData = useCallback(async () => {
    try {
      setLoading(true);
      const res = await api.get("/pages/slug/workout-essentials");
      ...
      console.error("WorkoutEssentials carousel error:", err);
      setCategories([]);
    } finally {
      setLoading(false);
    }
          ...
          >
            <div className="workout-category-octagon">
              {cat.image ? (
                ...
                <div className="workout-category-placeholder">
                  {cat.name}
                </div>
              )}
            </div>
