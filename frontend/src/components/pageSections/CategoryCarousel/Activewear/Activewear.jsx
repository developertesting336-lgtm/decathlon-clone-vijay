...
const Activewear = ({
  ...
  const fetchSectionData = useCallback(async () => {
    try {
      setLoading(true);
      const res = await api.get("/pages/slug/activewear");
      ...
      console.error("Activewear carousel error:", err);
      setCategories([]);
    } finally {
      setLoading(false);
    }
    ...
    <section className="category-carousel-activewear">
      ...
      <div className="activewear-category-track">
        {categories.map((cat, idx) => (
          <div
            key={cat._id || idx}
            className="activewear-category-card"
            onClick={() => handleCardClick(cat)}
          >
            <div className="activewear-category-circle">
              {cat.image ? (
                <img
                ...
                <div className="activewear-category-placeholder">
                  {cat.name}
                </div>
              )}
            </div>
