...
const Shoes = ({
  ...
  const fetchSectionData = useCallback(async () => {
    try {
      ...
      console.error("Shoes carousel error:", err);
      setCategories([]);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <section className="category-carousel-shoes">
      ...
      {sectionTitle &&
        ...
        sectionTitle !== "shoes" && (
          <h2 className="shoes-category-title">{sectionTitle}</h2>
        )}
      <div className="shoes-category-track">
        {categories.map((cat, idx) => (
          ...
          >
            <div className="shoes-category-image-box">
              {cat.image ? (
                <img
                ...
                <div className="shoes-category-placeholder">
                  {cat.name}
                </div>
              )}
            </div>
