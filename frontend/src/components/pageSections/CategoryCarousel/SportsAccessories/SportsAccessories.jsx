...
const SportsAccessories = ({
  ...
  const fetchSectionData = useCallback(async () => {
    try {
      setLoading(true);
      const res = await api.get("/pages/slug/sports-accessories");
      ...
      console.error("SportsAccessories carousel error:", err);
      setCategories([]);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <section className="category-carousel-sports-accessories">
      ...
      <div className="sports-acc-category-track">
        {categories.map((cat, idx) => (
          <div
            key={cat._id || idx}
            className="sports-acc-category-card"
            onClick={() => handleCardClick(cat)}
          >
            <div className="sports-acc-category-image-box">
              {cat.image ? (
                <img
                ...
                <div className="sports-acc-category-placeholder">
                  {cat.name}
                </div>
              )}
            </div>
